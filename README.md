...
| Почему super и MRO в Python вызывает столько вопросов? | [перейти к коду](videos/почему_super_и_MRO_в_Python_вызывает_столько_вопросов) |
| Typst: Современная замена Word и LaTeX, которую ждали 40 лет | [перейти к коду](videos/typst_vs_latex) |
